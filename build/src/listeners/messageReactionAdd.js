...
export default new Listener("messageReactionAdd", false, async (reaction, user) => {
    if (reaction.emoji.name === "💀") {
        if (reaction.message.partial) {
            ...
            const channel = cassia.channels.cache.find((channel) => (channel.id = skullboard.channelID));
